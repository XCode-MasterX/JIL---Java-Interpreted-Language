...
public class JILChar extends JILType{
    ...
    public JILType mul(Object operand, int line) {
        jil.error(line, "The multiplication operation is not supported for chars.");
        return null;
    }

    @Override
    public JILType div(Object operand, int line) {
        jil.error(line, "The division operation is not supported for chars.");
        return null;
    }

    @Override
    public JILType mod(Object operand, int line) {
        jil.error(line, "The mod operation is not supported for chars.");
        return null;
    }

    @Override
    public JILType power(Object operand, int line) {
        jil.error(line, "The power operation is not supported for chars.");
        return null;
    }
